...
const FFFilter ff_vf_overlay_sub = {
    .p.name        = "overlay_sub",
    .p.description = NULL_IF_CONFIG_SMALL("Overlay subtitles on video (2D or side-by-side 3D with depth offset)."),
    .p.priv_class  = &overlay_sub_class,
